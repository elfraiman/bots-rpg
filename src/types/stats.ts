...
export const MINIMAL_HIT_CHANCE = 0.45; // a fixed bonus to the hit chance (e.g., 5% or 0.05 in decimal form) to ensure there's always a minimal chance of hitting.
